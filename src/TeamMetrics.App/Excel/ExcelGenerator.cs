namespace TeamMetrics.App.Excel
{
    ...
    public static class ExcelGenerator
    {
		...
		public static ExcelPackage Generate<T>(string worksheetName, IList<Column<T>> columns, IList<T> data)
        {
        ...
        public static ExcelPackage Generate(string worksheetName, IEnumerable<object> array)
        {
